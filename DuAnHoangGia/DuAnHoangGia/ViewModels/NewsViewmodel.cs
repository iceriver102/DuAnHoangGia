...
namespace DuAnHoangGia.ViewModels
{
    ...
    {
        public DelegateCommand<HelpModel> ItemTapped { get; set; }
        ...
        public NewsViewmodel(INavigationService navigationService) : base(navigationService)
        {
            ...
            ItemTapped = new DelegateCommand<HelpModel>(ItemTappedExcute);
        }

        private void ItemTappedExcute(HelpModel obj)
        {
